...
#include "HasWeaponRuijterYannick.h"

#include "AIController.h"
#include "Common/InventoryComponent.h"
#include "Items/Weapon.h"

UHasWeaponRuijterYannick::UHasWeaponRuijterYannick()
{
}

bool UHasWeaponRuijterYannick::CalculateRawConditionValue(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory) const
{
