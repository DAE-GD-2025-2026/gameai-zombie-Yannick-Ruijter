#include "RotateCharacterRuijterYannick.h"
...
URotateCharacterRuijterYannick::URotateCharacterRuijterYannick()
{
...
void URotateCharacterRuijterYannick::OnBecomeRelevant(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
void URotateCharacterRuijterYannick::OnCeaseRelevant(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	AAIController* AIController = OwnerComp.GetAIOwner();
...
void URotateCharacterRuijterYannick::TickNode(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
