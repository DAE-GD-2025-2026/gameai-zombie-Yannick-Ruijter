...
#include "StudentPerceptorRuijterYannick.h"
...
UStudentPerceptorRuijterYannick::UStudentPerceptorRuijterYannick()
{
	PrimaryComponentTick.bCanEverTick = true;
}

void UStudentPerceptorRuijterYannick::BeginPlay()
{
	Super::BeginPlay();
	...
	{
		PerceptionComp->OnTargetPerceptionUpdated.AddDynamic(this, &UStudentPerceptorRuijterYannick::OnPerceptionUpdated);
	}
...
void UStudentPerceptorRuijterYannick::TickComponent(float DeltaTime, ELevelTick TickType,
...
FVector UStudentPerceptorRuijterYannick::GetAverageZombieLocation()
{
	FVector Location = FVector::ZeroVector;
	int32 ValidCount = 0;

	if (CloseZombies.IsEmpty()) FVector::ZeroVector;
	for (int i = CloseZombies.Num() - 1; i >= 0; i--)
	{
		if (!IsValid(CloseZombies[i]))
		{
...
ABaseZombie* UStudentPerceptorRuijterYannick::GetClosestZombie()
{
...
ABaseItem* UStudentPerceptorRuijterYannick::GetNeededItem()
{
...
void UStudentPerceptorRuijterYannick::UpdateNeededItems()
{
...
void UStudentPerceptorRuijterYannick::OnPerceptionUpdated(AActor* Actor, FAIStimulus Stimulus)
{
...
AHouse* UStudentPerceptorRuijterYannick::GetNextHouse() const
{
...
void UStudentPerceptorRuijterYannick::AdvanceHouseIndex()
{
