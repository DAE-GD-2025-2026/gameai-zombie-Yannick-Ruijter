...
#include "StudentPerceptorRuijterYannick.generated.h"

UCLASS(ClassGroup=(Custom), meta=(BlueprintSpawnableComponent))
class RUIJTERYANNICKZOMBIERUNTIME_API UStudentPerceptorRuijterYannick : public UActorComponent
{
	GENERATED_BODY()

public:
	// Sets default values for this component's properties
	UStudentPerceptorRuijterYannick();
    UPROPERTY()
