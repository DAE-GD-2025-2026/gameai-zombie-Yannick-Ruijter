#include "CalculateNextRingPosRuijterYannick.h"
#include "AIController.h"
#include "BehaviorTree/BlackboardComponent.h"

UCalculateNextRingPosRuijterYannick::UCalculateNextRingPosRuijterYannick()
{
...
EBTNodeResult::Type UCalculateNextRingPosRuijterYannick::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
FString UCalculateNextRingPosRuijterYannick::GetStaticDescription() const
{
